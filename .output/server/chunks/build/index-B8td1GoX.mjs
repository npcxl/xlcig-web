...
import { ref, h, mergeProps, withCtx, createTextVNode, unref, defineComponent, createVNode, createBlock, openBlock, toDisplayString, toRef, computed, provide, watch, cloneVNode, Text, withDirectives, watchEffect, inject, getCurrentInstance, Transition, vShow, nextTick, Fragment, useSSRContext } from 'vue';
...
import { u as useLocation } from './useLocation-DfI38ycp.mjs';
import { _ as _export_sfc } from './server.mjs';
import { u as useHead } from './v3-B75LsvLO.mjs';
import { N as NConfigProvider, s as self$7$1, a as self$J, b as self$3$1, c as self$4$1, d as self$1$1, e as derived$1, f as commonVariables$3$1, g as self$6$1, h as self$5$1, k as keep, u as useConfig, i as useTheme, j as createInjectionKey, l as call, m as createKey, n as useThemeClass, o as getFirstSlotVNode, p as createTheme, q as modalBodyInjectionKey, r as drawerBodyInjectionKey, t as popoverBodyInjectionKey, v as getSlot, w as getFirstVNode, X as XScrollbar, x as cB, y as fadeInScaleUpTransition, z as c$1, A as cNotM, B as cM, C as cE, L as LazyTeleport, D as useSsrAdapter, E as isSlotEmpty, F as FocusTrap, G as warn, H as render, I as cCB, J as resolveWrappedSlot } from './discrete-DcZNj1Jm.mjs';
import { scaleColor, changeColor, composite, rgba, getPreciseEventTarget, happensIn, beforeNextFrameOnce } from 'seemly';
import { createTreeMate } from 'treemate';
import { useMergedState, useMemo, useKeyboard, useIsMounted, useCompitable, onFontsReady } from 'vooks';
...
const buttonDark = {
  ...
  common: derived,
  self(vars) {
    const commonSelf = self$6$1(vars);
...
const cardDark = {
  ...
  common: derived,
  self(vars) {
    const commonSelf = self$5$1(vars);
    const {
      cardColor,
      modalColor,
      popoverColor
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "header-location" }, _attrs))} data-v-21c98243>`);
      if (unref(hasLocation)) {
        _push(`<div class="location-display" data-v-21c98243><button class="location-button"${ssrRenderAttr("title", `\u5F53\u524D\u4F4D\u7F6E: ${unref(getLocationText)()}`)} data-v-21c98243><i class="bi bi-geo-alt location-icon" data-v-21c98243></i><span class="location-text" data-v-21c98243>${ssrInterpolate(unref(getLocationText)())}</span><i class="${ssrRenderClass([{ "rotate-180": showDetails.value }, "bi bi-chevron-down detail-icon"])}" data-v-21c98243></i></button>`);
        if (showDetails.value) {
          _push(`<div class="location-details" data-v-21c98243><div class="detail-item" data-v-21c98243><span class="detail-label" data-v-21c98243>IP:</span><span class="detail-value" data-v-21c98243>${ssrInterpolate(unref(currentIp))}</span></div>`);
          if ((_a = unref(data)) == null ? void 0 : _a.location.province) {
            _push(`<div class="detail-item" data-v-21c98243><span class="detail-label" data-v-21c98243>\u7701\u4EFD:</span><span class="detail-value" data-v-21c98243>${ssrInterpolate(unref(data).location.province)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          if ((_b = unref(data)) == null ? void 0 : _b.location.city) {
            _push(`<div class="detail-item" data-v-21c98243><span class="detail-label" data-v-21c98243>\u57CE\u5E02:</span><span class="detail-value" data-v-21c98243>${ssrInterpolate(unref(data).location.city)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="detail-item" data-v-21c98243><span class="detail-label" data-v-21c98243>\u72B6\u6001:</span><span class="detail-value" data-v-21c98243>`);
          if ((_c = unref(data)) == null ? void 0 : _c.cached) {
            _push(`<span class="cache-tag" data-v-21c98243>\u7F13\u5B58</span>`);
          } else {
            _push(`<span class="live-tag" data-v-21c98243>\u5B9E\u65F6</span>`);
          }
          _push(`</span></div><div class="detail-actions" data-v-21c98243><button${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} class="refresh-btn" data-v-21c98243><i class="${ssrRenderClass([{ "animate-spin": unref(loading) }, "bi bi-arrow-clockwise"])}" data-v-21c98243></i> \u5237\u65B0 </button></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      } else if (unref(loading)) {
        _push(`<div class="loading-display" data-v-21c98243><i class="bi bi-geo-alt location-icon opacity-50" data-v-21c98243></i><span class="location-text" data-v-21c98243>\u5B9A\u4F4D\u4E2D...</span><div class="loading-spinner" data-v-21c98243></div></div>`);
      } else if (unref(error)) {
        _push(`<div class="error-display" data-v-21c98243><button class="location-button error" title="\u70B9\u51FB\u91CD\u65B0\u83B7\u53D6\u5B9A\u4F4D" data-v-21c98243><i class="bi bi-geo-alt-fill location-icon" data-v-21c98243></i><span class="location-text" data-v-21c98243>\u5B9A\u4F4D\u5931\u8D25</span><i class="bi bi-arrow-clockwise detail-icon" data-v-21c98243></i></button></div>`);
      } else {
        _push(`<div class="initial-display" data-v-21c98243><button class="location-button" title="\u70B9\u51FB\u83B7\u53D6\u5B9A\u4F4D" data-v-21c98243><i class="bi bi-geo location-icon" data-v-21c98243></i><span class="location-text" data-v-21c98243>\u83B7\u53D6\u5B9A\u4F4D</span></button></div>`);
      }
      _push(`</div>`);
    };
  }
...
const HeaderLocation = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-21c98243"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    const handleUserMenuSelect = (key) => {
      ...
      switch (key) {
        case "profile":
          (void 0).location.href = "/profile";
          break;
        case "orders":
          (void 0).location.href = "/orders";
          break;
        case "addresses":
          (void 0).location.href = "/addresses";
          break;
        case "logout":
          userStore.logout();
          break;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black relative overflow-hidden" }, _attrs))} data-v-29948245><div class="fixed inset-0 pointer-events-none" data-v-29948245><div class="absolute top-20 left-20 w-96 h-96 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full filter blur-3xl animate-pulse" data-v-29948245></div><div class="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full filter blur-3xl animate-pulse delay-1000" data-v-29948245></div><div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 rounded-full filter blur-3xl animate-spin-slow" data-v-29948245></div></div><nav class="relative z-10" data-v-29948245><div class="container mx-auto px-6 py-6" data-v-29948245><div class="glass-card-dark rounded-2xl p-6 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20" data-v-29948245><div class="flex items-center justify-between" data-v-29948245><div class="flex items-center space-x-8" data-v-29948245>`);
      _push(ssrRenderComponent(_component_AppLogo, { size: "large" }, null, _parent));
      _push(`<div class="hidden md:flex space-x-6" data-v-29948245>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "text-white hover:text-cyan-400 transition-colors duration-200 font-medium"
      }, {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/products",
        class: "text-gray-300 hover:text-cyan-400 transition-colors duration-200 font-medium"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`\u4EA7\u54C1\u4E2D\u5FC3`);
      ...
      _push(`</div></div><div class="flex items-center space-x-4" data-v-29948245>`);
      _push(ssrRenderComponent(HeaderLocation, null, null, _parent));
      _push(`<button class="p-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200" data-v-29948245><i class="bi bi-search text-xl" data-v-29948245></i></button><button class="p-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200" data-v-29948245><i class="bi bi-bell text-xl" data-v-29948245></i></button>`);
      if (!unref(userStore).isLoggedIn) {
        _push(`<div class="flex items-center space-x-3" data-v-29948245>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/auth/login",
        ...
        _push(`<div class="relative" data-v-29948245>`);
            ...
            if (_push2) {
              _push2(ssrRenderComponent(unref(NDropdown), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  var _a, _b;
                  if (_push3) {
                    _push3(`<button class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-800/50 transition-colors duration-200" data-v-29948245${_scopeId2}><div class="w-8 h-8 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center text-white font-semibold text-sm overflow-hidden" data-v-29948245${_scopeId2}>`);
                    if (unref(userStore).hasAvatarImage) {
                      _push3(`<img${ssrRenderAttr("src", (_a = unref(userStore).user) == null ? void 0 : _a.avatar)}${ssrRenderAttr("alt", unref(userStore).userDisplayName + "\u7684\u5934\u50CF")} class="w-full h-full object-cover" data-v-29948245${_scopeId2}>`);
                    } else {
                      _push3(`<span data-v-29948245${_scopeId2}>${ssrInterpolate(unref(userStore).userAvatar)}</span>`);
                    }
                    _push3(`</div><span class="text-white font-medium hidden md:block" data-v-29948245${_scopeId2}>${ssrInterpolate(unref(userStore).userDisplayName)}</span><i class="bi bi-chevron-down text-gray-400 text-sm" data-v-29948245${_scopeId2}></i></button>`);
                  } else {
                    return [
      ...
      _push(`</div></div></div></div></nav><section class="relative z-10 py-20" data-v-29948245><div class="container mx-auto px-6" data-v-29948245><div class="text-center" data-v-29948245><div class="glass-card-dark rounded-3xl p-12 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-4xl mx-auto" data-v-29948245><h1 class="text-5xl md:text-7xl font-bold text-white leading-tight mb-8" data-v-29948245> \u4E13\u4E1A<span class="text-cyan-400" data-v-29948245>xlCig</span><br data-v-29948245><span class="text-3xl md:text-5xl text-gray-300 font-normal" data-v-29948245>PC\u786C\u4EF6\u4E13\u5BB6</span></h1><p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed" data-v-29948245> \u4E3A\u60A8\u63D0\u4F9B\u4E13\u4E1A\u7684PC\u786C\u4EF6\u4EA7\u54C1\u548C\u88C5\u673A\u5EFA\u8BAE\uFF0C\u52A9\u60A8\u6253\u9020\u68A6\u60F3\u4E2D\u7684\u9AD8\u6027\u80FD\u7535\u8111 </p><div class="flex flex-col sm:flex-row gap-4 justify-center items-center" data-v-29948245>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/products",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<i class="bi bi-shop mr-3 text-xl" data-v-29948245${_scopeId}></i> \u6D4F\u89C8\u4EA7\u54C1 `);
          } else {
            return [
              createVNode("i", { class: "bi bi-shop mr-3 text-xl" }),
      ...
      _push(`<button class="inline-flex items-center px-8 py-4 border-2 border-cyan-500/50 hover:border-cyan-400 text-cyan-300 hover:text-white font-semibold rounded-xl transition-all duration-300 hover:bg-cyan-500/10 transform hover:-translate-y-1" data-v-29948245><i class="bi bi-play-circle mr-3 text-xl" data-v-29948245></i> \u89C2\u770B\u4ECB\u7ECD </button></div></div></div></div></section><section class="relative z-10 py-16" data-v-29948245><div class="container mx-auto px-6" data-v-29948245><div class="text-center mb-16" data-v-29948245><h2 class="text-4xl font-bold text-white mb-4" data-v-29948245>\u6211\u4EEC\u7684\u670D\u52A1</h2><p class="text-gray-300 text-lg" data-v-29948245>\u4E13\u4E1A\u7684\u786C\u4EF6\u9009\u62E9\u548C\u88C5\u673A\u670D\u52A1</p></div><div class="grid md:grid-cols-3 gap-8" data-v-29948245><div class="glass-card-dark rounded-2xl p-8 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 text-center hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2" data-v-29948245><div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-2xl flex items-center justify-center" data-v-29948245><i class="bi bi-star-fill text-white text-2xl" data-v-29948245></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-29948245>\u7CBE\u9009\u4EA7\u54C1</h3><p class="text-gray-300 leading-relaxed" data-v-29948245>\u7CBE\u5FC3\u6311\u9009\u7684\u9AD8\u54C1\u8D28PC\u786C\u4EF6\uFF0C\u786E\u4FDD\u6027\u80FD\u4E0E\u4EF7\u683C\u7684\u5B8C\u7F8E\u5E73\u8861</p></div><div class="glass-card-dark rounded-2xl p-8 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 text-center hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2" data-v-29948245><div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center" data-v-29948245><i class="bi bi-currency-dollar text-white text-2xl" data-v-29948245></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-29948245>\u4F18\u60E0\u4EF7\u683C</h3><p class="text-gray-300 leading-relaxed" data-v-29948245>\u76F4\u63A5\u4E0E\u5382\u5546\u5408\u4F5C\uFF0C\u4E3A\u60A8\u63D0\u4F9B\u6700\u5177\u7ADE\u4E89\u529B\u7684\u4EF7\u683C\u548C\u4FC3\u9500\u6D3B\u52A8</p></div><div class="glass-card-dark rounded-2xl p-8 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 text-center hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2" data-v-29948245><div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center" data-v-29948245><i class="bi bi-joystick text-white text-2xl" data-v-29948245></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-29948245>\u6E38\u620F\u4F53\u9A8C</h3><p class="text-gray-300 leading-relaxed" data-v-29948245>\u9488\u5BF9\u6E38\u620F\u9700\u6C42\u4F18\u5316\u7684\u914D\u7F6E\u65B9\u6848\uFF0C\u8BA9\u60A8\u4EAB\u53D7\u6781\u81F4\u7684\u6E38\u620F\u4F53\u9A8C</p></div></div></div></section><section class="relative z-10 py-16" data-v-29948245><div class="container mx-auto px-6" data-v-29948245><div class="text-center mb-16" data-v-29948245><h2 class="text-4xl font-bold text-white mb-4" data-v-29948245>\u70ED\u95E8\u4EA7\u54C1</h2><p class="text-gray-300 text-lg" data-v-29948245>\u6700\u53D7\u6B22\u8FCE\u7684PC\u786C\u4EF6\u4EA7\u54C1</p></div>`);
      if (unref(loading)) {
        _push(`<div class="text-center py-16" data-v-29948245><div class="glass-card-dark rounded-2xl p-12 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-md mx-auto" data-v-29948245><div class="w-12 h-12 border-4 border-cyan-500 border-t-transparent rounded-full animate-spin mx-auto mb-6" data-v-29948245></div><p class="text-xl font-medium text-white" data-v-29948245>\u6B63\u5728\u52A0\u8F7D\u70ED\u95E8\u4EA7\u54C1...</p><p class="text-gray-400 mt-2" data-v-29948245>\u8BF7\u7A0D\u5019</p></div></div>`);
      } else if (!unref(loading) && unref(featuredProducts).length === 0) {
        _push(`<div class="text-center py-16" data-v-29948245><div class="glass-card-dark rounded-2xl p-12 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-md mx-auto" data-v-29948245><div class="text-8xl mb-8 text-cyan-400 opacity-50" data-v-29948245><i class="bi bi-inbox" data-v-29948245></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-29948245>\u6682\u65E0\u70ED\u95E8\u4EA7\u54C1</h3><p class="text-gray-400 mb-8 text-lg" data-v-29948245>\u5546\u5BB6\u8FD8\u6CA1\u6709\u4E0A\u4F20\u4EA7\u54C1\uFF0C\u8BF7\u7A0D\u540E\u518D\u6765\u67E5\u770B</p><button class="px-8 py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-medium rounded-lg transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40" data-v-29948245><i class="bi bi-arrow-clockwise mr-2" data-v-29948245></i> \u91CD\u65B0\u52A0\u8F7D </button></div></div>`);
      } else {
        _push(`<div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6" data-v-29948245><!--[-->`);
        ssrRenderList(unref(featuredProducts), (product) => {
          _push(`<div class="glass-card-dark rounded-2xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 overflow-hidden hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2 group" data-v-29948245><div class="relative h-48 bg-gradient-to-br from-gray-800/50 to-gray-900/50" data-v-29948245>`);
          if (product.image) {
            _push(`<div class="home-product-image-container" data-v-29948245><img${ssrRenderAttr("src", product.image)}${ssrRenderAttr("alt", product.name)} class="w-full h-full object-contain p-4 group-hover:scale-105 transition-transform duration-300" data-v-29948245></div>`);
          } else {
            _push(`<div class="home-product-placeholder" data-v-29948245><i class="${ssrRenderClass(getHomeProductIcon(product.name))}" data-v-29948245></i><span class="home-product-type" data-v-29948245>${ssrInterpolate(getProductTypeName(product.name))}</span></div>`);
          }
          _push(`<div class="absolute top-3 right-3" data-v-29948245><span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-500/20 text-green-300 border border-green-500/30" data-v-29948245><i class="bi bi-fire mr-1" data-v-29948245></i>\u70ED\u95E8 </span></div></div><div class="p-6" data-v-29948245><h3 class="font-semibold text-white text-lg mb-2 line-clamp-2" data-v-29948245>${ssrInterpolate(product.name)}</h3><p class="text-gray-400 text-sm mb-4 line-clamp-2" data-v-29948245>${ssrInterpolate(product.description)}</p><div class="flex items-center justify-between" data-v-29948245><div class="text-2xl font-bold text-cyan-400" data-v-29948245>\xA5${ssrInterpolate(product.price.toLocaleString())}</div><div class="flex" data-v-29948245><!--[-->`);
          ssrRenderList(5, (i) => {
            _push(`<i class="${ssrRenderClass([i <= product.rating ? "text-yellow-400" : "text-gray-600", "bi bi-star-fill text-sm"])}" data-v-29948245></i>`);
          });
          _push(`<!--]--></div></div><button class="w-full mt-4 px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white text-sm font-medium rounded-lg transition-all duration-300" data-v-29948245> \u67E5\u770B\u8BE6\u60C5 </button></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      if (!unref(loading) && unref(featuredProducts).length > 0) {
        _push(`<div class="text-center mt-12" data-v-29948245>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/products",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="bi bi-grid-3x3-gap mr-3 text-xl" data-v-29948245${_scopeId}></i> \u67E5\u770B\u5168\u90E8\u4EA7\u54C1 `);
            } else {
              return [
                createVNode("i", { class: "bi bi-grid-3x3-gap mr-3 text-xl" }),
      ...
      _push(`</div></section><section class="relative z-10 py-16" data-v-29948245><div class="container mx-auto px-6" data-v-29948245><div class="text-center mb-16" data-v-29948245><h2 class="text-4xl font-bold text-white mb-4" data-v-29948245>\u88C5\u673A\u914D\u7F6E\u63A8\u8350</h2><p class="text-gray-300 text-lg" data-v-29948245>\u6839\u636E\u4E0D\u540C\u9700\u6C42\u7CBE\u5FC3\u642D\u914D\u7684\u914D\u7F6E\u65B9\u6848</p></div>`);
      if (unref(loading)) {
        _push(`<div class="text-center py-16" data-v-29948245><div class="glass-card-dark rounded-2xl p-12 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-md mx-auto" data-v-29948245><div class="w-12 h-12 border-4 border-cyan-500 border-t-transparent rounded-full animate-spin mx-auto mb-6" data-v-29948245></div><p class="text-xl font-medium text-white" data-v-29948245>\u6B63\u5728\u52A0\u8F7D\u914D\u7F6E\u63A8\u8350...</p><p class="text-gray-400 mt-2" data-v-29948245>\u8BF7\u7A0D\u5019</p></div></div>`);
      } else if (!unref(loading) && unref(configurations).length === 0) {
        _push(`<div class="text-center py-16" data-v-29948245><div class="glass-card-dark rounded-2xl p-12 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-md mx-auto" data-v-29948245><div class="text-8xl mb-8 text-cyan-400 opacity-50" data-v-29948245><i class="bi bi-cpu" data-v-29948245></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-29948245>\u6682\u65E0\u914D\u7F6E\u63A8\u8350</h3><p class="text-gray-400 mb-8 text-lg" data-v-29948245>\u5546\u5BB6\u8FD8\u6CA1\u6709\u4E0A\u4F20\u914D\u7F6E\u65B9\u6848\uFF0C\u8BF7\u7A0D\u540E\u518D\u6765\u67E5\u770B</p><button class="px-8 py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-medium rounded-lg transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40" data-v-29948245><i class="bi bi-arrow-clockwise mr-2" data-v-29948245></i> \u91CD\u65B0\u52A0\u8F7D </button></div></div>`);
      } else {
        _push(`<div class="grid md:grid-cols-3 gap-8" data-v-29948245><!--[-->`);
        ssrRenderList(unref(configurations), (config) => {
          _push(`<div class="glass-card-dark rounded-2xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 overflow-hidden hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2" data-v-29948245><div class="p-6 border-b border-gray-700/50" data-v-29948245><div class="flex items-center justify-between mb-4" data-v-29948245><h3 class="text-2xl font-semibold text-white" data-v-29948245>${ssrInterpolate(config.name)}</h3><span class="${ssrRenderClass(config.badgeClass)}" data-v-29948245>${ssrInterpolate(config.badge)}</span></div><p class="text-gray-300 mb-4" data-v-29948245>${ssrInterpolate(config.description)}</p><div class="text-3xl font-bold text-cyan-400 mb-2" data-v-29948245>\xA5${ssrInterpolate(config.price.toLocaleString())}</div><div class="text-sm text-gray-400" data-v-29948245>\u9884\u4F30\u6027\u80FD\u5206\u6570\uFF1A${ssrInterpolate(config.score)}</div></div><div class="p-6" data-v-29948245><div class="space-y-3 mb-6" data-v-29948245><!--[-->`);
          ssrRenderList(config.components, (component) => {
            _push(`<div class="flex justify-between items-center p-3 bg-gray-800/30 rounded-lg" data-v-29948245><span class="text-gray-300 text-sm" data-v-29948245>${ssrInterpolate(component.type)}</span><span class="text-white text-sm font-medium" data-v-29948245>${ssrInterpolate(component.name)}</span></div>`);
          });
          _push(`<!--]--></div><button class="w-full px-4 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold rounded-lg transition-all duration-300" data-v-29948245> \u9009\u62E9\u6B64\u914D\u7F6E </button></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div></section><footer class="relative z-10 mt-20" data-v-29948245><div class="container mx-auto px-6 py-12" data-v-29948245><div class="glass-card-dark rounded-2xl p-8 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20" data-v-29948245><div class="text-center" data-v-29948245><div class="flex justify-center mb-4" data-v-29948245>`);
      _push(ssrRenderComponent(_component_AppLogo, {
        size: "medium",
        "show-decorations": false
      }, null, _parent));
      _push(`</div><p class="text-gray-300 mb-6" data-v-29948245>\u4E13\u4E1A\u7684PC\u786C\u4EF6\u4EA7\u54C1\u548C\u88C5\u673A\u670D\u52A1</p><div class="flex justify-center space-x-6 text-gray-400" data-v-29948245><a href="#" class="hover:text-cyan-400 transition-colors duration-200" data-v-29948245>\u5173\u4E8E\u6211\u4EEC</a><a href="#" class="hover:text-cyan-400 transition-colors duration-200" data-v-29948245>\u8054\u7CFB\u65B9\u5F0F</a><a href="#" class="hover:text-cyan-400 transition-colors duration-200" data-v-29948245>\u670D\u52A1\u6761\u6B3E</a><a href="#" class="hover:text-cyan-400 transition-colors duration-200" data-v-29948245>\u9690\u79C1\u653F\u7B56</a></div><div class="mt-6 pt-6 border-t border-gray-700/50 text-gray-500 text-sm" data-v-29948245> \xA9 2024 xlCig. \u4FDD\u7559\u6240\u6709\u6743\u5229. </div></div></div></div></footer></div>`);
    };
  }
};
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-29948245"]]);

export { index as default };
//# sourceMappingURL=index-B8td1GoX.mjs.map
