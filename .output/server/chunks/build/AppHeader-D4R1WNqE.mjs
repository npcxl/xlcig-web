...
import { _ as __nuxt_component_0$2 } from './AppLogo-B7Z3yKfV.mjs';
import { computed, h, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, unref, defineComponent, createBlock, openBlock, ref, toRef, provide, watch, cloneVNode, Text, withDirectives, watchEffect, inject, getCurrentInstance, Transition, vShow, nextTick, Fragment, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { u as useUserStore } from './server.mjs';
import { useRouter, useRoute } from 'vue-router';
import { N as NConfigProvider, s as self$7$1, a as self$J, b as self$3$1, d as self$4$1, e as self$1$1, f as derived$1, g as commonVariables$3$1, h as self$6$1, i as self$5$1, k as keep, j as useConfig, l as useTheme, m as createInjectionKey, n as call, o as createKey, p as useThemeClass, u as useLocation, q as getFirstSlotVNode, r as createTheme, t as modalBodyInjectionKey, v as drawerBodyInjectionKey, w as popoverBodyInjectionKey, x as getSlot, y as getFirstVNode, X as XScrollbar, z as cB, A as fadeInScaleUpTransition, B as c$1, C as cNotM, D as cM, E as cE, F as LazyTeleport, G as useSsrAdapter, H as isSlotEmpty, I as FocusTrap, J as warn, K as render, M as cCB, O as resolveWrappedSlot } from './useLocation-DU515pZE.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "header-location" }, _attrs))} data-v-e6789a7e>`);
      if (unref(hasLocation)) {
        _push(`<div class="location-display" data-v-e6789a7e><button class="location-button"${ssrRenderAttr("title", `\u5F53\u524D\u4F4D\u7F6E: ${unref(getLocationText)()}`)} data-v-e6789a7e><i class="bi bi-geo-alt location-icon" data-v-e6789a7e></i><span class="location-text" data-v-e6789a7e>${ssrInterpolate(unref(getLocationText)())}</span><i class="${ssrRenderClass([{ "rotate-180": showDetails.value }, "bi bi-chevron-down detail-icon"])}" data-v-e6789a7e></i></button>`);
        if (showDetails.value) {
          _push(`<div class="location-details" data-v-e6789a7e><div class="detail-item" data-v-e6789a7e><span class="detail-label" data-v-e6789a7e>IP:</span><span class="detail-value" data-v-e6789a7e>${ssrInterpolate(unref(currentIp))}</span></div>`);
          if ((_b = (_a = unref(data)) == null ? void 0 : _a.location) == null ? void 0 : _b.province) {
            _push(`<div class="detail-item" data-v-e6789a7e><span class="detail-label" data-v-e6789a7e>\u7701\u4EFD:</span><span class="detail-value" data-v-e6789a7e>${ssrInterpolate(unref(data).location.province)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          if ((_d = (_c = unref(data)) == null ? void 0 : _c.location) == null ? void 0 : _d.city) {
            _push(`<div class="detail-item" data-v-e6789a7e><span class="detail-label" data-v-e6789a7e>\u57CE\u5E02:</span><span class="detail-value" data-v-e6789a7e>${ssrInterpolate(unref(data).location.city)}</span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="detail-item" data-v-e6789a7e><span class="detail-label" data-v-e6789a7e>\u72B6\u6001:</span><span class="detail-value" data-v-e6789a7e>`);
          if ((_e = unref(data)) == null ? void 0 : _e.cached) {
            _push(`<span class="cache-tag" data-v-e6789a7e>\u7F13\u5B58</span>`);
          } else {
            _push(`<span class="live-tag" data-v-e6789a7e>\u5B9E\u65F6</span>`);
          }
          _push(`</span></div>`);
          if (((_f = unref(data)) == null ? void 0 : _f.location) && !unref(data).location.province && !unref(data).location.city) {
            _push(`<div class="detail-info" data-v-e6789a7e><div class="info-text" data-v-e6789a7e><i class="bi bi-info-circle text-yellow-500" data-v-e6789a7e></i><span data-v-e6789a7e>\u4F4D\u7F6E\u4FE1\u606F\u53EF\u80FD\u4E0D\u591F\u7CBE\u786E</span></div><div class="info-detail" data-v-e6789a7e> \u53EF\u80FD\u539F\u56E0\uFF1A\u79FB\u52A8\u7F51\u7EDC\u3001\u4EE3\u7406\u7B49 </div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="detail-actions" data-v-e6789a7e><button${ssrIncludeBooleanAttr(unref(loading)) ? " disabled" : ""} class="refresh-btn" data-v-e6789a7e><i class="${ssrRenderClass([{ "animate-spin": unref(loading) }, "bi bi-arrow-clockwise"])}" data-v-e6789a7e></i> \u5237\u65B0 </button></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      } else if (unref(loading)) {
        _push(`<div class="loading-display" data-v-e6789a7e><i class="bi bi-geo-alt location-icon opacity-50" data-v-e6789a7e></i><span class="location-text" data-v-e6789a7e>\u5B9A\u4F4D\u4E2D...</span><div class="loading-spinner" data-v-e6789a7e></div></div>`);
      } else if (unref(error)) {
        _push(`<div class="error-display" data-v-e6789a7e><button class="location-button error" title="\u70B9\u51FB\u91CD\u65B0\u83B7\u53D6\u5B9A\u4F4D" data-v-e6789a7e><i class="bi bi-geo-alt-fill location-icon" data-v-e6789a7e></i><span class="location-text" data-v-e6789a7e>\u5B9A\u4F4D\u5931\u8D25</span><i class="bi bi-arrow-clockwise detail-icon" data-v-e6789a7e></i></button></div>`);
      } else {
        _push(`<div class="initial-display" data-v-e6789a7e><button class="location-button" title="\u70B9\u51FB\u83B7\u53D6\u5B9A\u4F4D" data-v-e6789a7e><i class="bi bi-geo location-icon" data-v-e6789a7e></i><span class="location-text" data-v-e6789a7e>\u83B7\u53D6\u5B9A\u4F4D</span></button></div>`);
      }
      _push(`</div>`);
    };
  }
...
const HeaderLocation = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e6789a7e"]]);
const _sfc_main = {
  __name: "AppHeader",
  __ssrInlineRender: true,
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "relative z-10" }, _attrs))} data-v-7f4e82bd><div class="container mx-auto px-6 py-6" data-v-7f4e82bd><div class="glass-card-dark rounded-2xl p-6 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20" data-v-7f4e82bd><div class="flex items-center justify-between" data-v-7f4e82bd><div class="flex items-center space-x-6" data-v-7f4e82bd>`);
      ...
      if (__props.showBackButton) {
        _push(`<div class="h-6 w-px bg-gray-600" data-v-7f4e82bd></div>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.showBackButton) {
        _push(`<button class="group relative inline-flex items-center px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:-translate-y-1 hover:scale-105 overflow-hidden" data-v-7f4e82bd><div class="absolute inset-0 bg-gradient-to-r from-cyan-600/20 via-blue-600/20 to-purple-600/20 rounded-xl transition-all duration-300 group-hover:from-cyan-500/30 group-hover:via-blue-500/30 group-hover:to-purple-500/30" data-v-7f4e82bd></div><div class="absolute inset-0 border-2 border-cyan-500/30 rounded-xl transition-all duration-300 group-hover:border-cyan-400/60 group-hover:shadow-lg group-hover:shadow-cyan-400/25" data-v-7f4e82bd></div><div class="absolute inset-0 rounded-xl overflow-hidden" data-v-7f4e82bd><div class="absolute w-2 h-2 bg-cyan-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-ping" style="${ssrRenderStyle({ "top": "20%", "left": "15%", "animation-delay": "0s" })}" data-v-7f4e82bd></div><div class="absolute w-1 h-1 bg-blue-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-ping" style="${ssrRenderStyle({ "top": "60%", "left": "80%", "animation-delay": "0.2s" })}" data-v-7f4e82bd></div><div class="absolute w-1.5 h-1.5 bg-purple-400 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-ping" style="${ssrRenderStyle({ "top": "80%", "left": "30%", "animation-delay": "0.4s" })}" data-v-7f4e82bd></div></div><div class="relative flex items-center" data-v-7f4e82bd><div class="w-10 h-10 rounded-full bg-gradient-to-r from-cyan-500/20 to-blue-500/20 flex items-center justify-center mr-3 transition-all duration-300 group-hover:from-cyan-400/40 group-hover:to-blue-400/40 group-hover:scale-110" data-v-7f4e82bd><i class="bi bi-arrow-left text-cyan-400 text-lg transition-all duration-300 group-hover:text-white group-hover:-translate-x-1" data-v-7f4e82bd></i></div><div class="text-left" data-v-7f4e82bd><div class="text-white text-sm font-semibold transition-all duration-300 group-hover:text-cyan-100" data-v-7f4e82bd>\u8FD4\u56DE</div><div class="text-gray-400 text-xs transition-all duration-300 group-hover:text-cyan-300" data-v-7f4e82bd>Back</div></div></div><div class="absolute right-3 top-1/2 transform -translate-y-1/2" data-v-7f4e82bd><div class="flex flex-col space-y-1 opacity-60 group-hover:opacity-100 transition-opacity duration-300" data-v-7f4e82bd><div class="w-6 h-0.5 bg-gradient-to-r from-cyan-400 to-transparent rounded-full transition-all duration-300 group-hover:w-8" data-v-7f4e82bd></div><div class="w-4 h-0.5 bg-gradient-to-r from-blue-400 to-transparent rounded-full transition-all duration-300 group-hover:w-6 delay-75" data-v-7f4e82bd></div><div class="w-2 h-0.5 bg-gradient-to-r from-purple-400 to-transparent rounded-full transition-all duration-300 group-hover:w-4 delay-150" data-v-7f4e82bd></div></div></div></button>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.showNavMenu) {
        _push(`<div class="hidden md:flex space-x-6" data-v-7f4e82bd><!--[-->`);
      ...
      _push(`</div><div class="flex items-center space-x-4" data-v-7f4e82bd>`);
      if (__props.showBreadcrumb) {
        _push(`<nav class="text-sm text-gray-400" data-v-7f4e82bd>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/",
        ...
        _push(`<i class="bi bi-chevron-right mx-2 text-cyan-400" data-v-7f4e82bd></i><span class="text-white font-medium" data-v-7f4e82bd>${ssrInterpolate(__props.currentPageTitle)}</span></nav>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (__props.showSearchButton) {
        _push(`<button class="p-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200" data-v-7f4e82bd><i class="bi bi-search text-xl" data-v-7f4e82bd></i></button>`);
      } else {
        _push(`<!---->`);
      }
      if (__props.showNotificationButton) {
        _push(`<button class="p-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200" data-v-7f4e82bd><i class="bi bi-bell text-xl" data-v-7f4e82bd></i></button>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(userStore).isLoggedIn) {
        _push(`<div class="flex items-center space-x-3" data-v-7f4e82bd>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/auth/login",
        ...
        _push(`<div class="relative" data-v-7f4e82bd>`);
            ...
            if (_push2) {
              _push2(ssrRenderComponent(unref(NDropdown), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  var _a, _b;
                  if (_push3) {
                    _push3(`<button class="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-800/50 transition-colors duration-200" data-v-7f4e82bd${_scopeId2}><div class="w-8 h-8 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center text-white font-semibold text-sm overflow-hidden" data-v-7f4e82bd${_scopeId2}>`);
                    if (unref(userStore).hasAvatarImage) {
                      _push3(`<img${ssrRenderAttr("src", (_a = unref(userStore).user) == null ? void 0 : _a.avatar)}${ssrRenderAttr("alt", unref(userStore).userDisplayName + "\u7684\u5934\u50CF")} class="w-full h-full object-cover" data-v-7f4e82bd${_scopeId2}>`);
                    } else {
                      _push3(`<span data-v-7f4e82bd${_scopeId2}>${ssrInterpolate(unref(userStore).userAvatar)}</span>`);
                    }
                    _push3(`</div><span class="text-white font-medium hidden md:block" data-v-7f4e82bd${_scopeId2}>${ssrInterpolate(unref(userStore).userDisplayName)}</span><i class="bi bi-chevron-down text-gray-400 text-sm" data-v-7f4e82bd${_scopeId2}></i></button>`);
                  } else {
                    return [
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7f4e82bd"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=AppHeader-D4R1WNqE.mjs.map
