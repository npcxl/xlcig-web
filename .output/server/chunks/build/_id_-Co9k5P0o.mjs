...
const _sfc_main$1 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "glass-card-enhanced rounded-2xl border border-cyan-400/40 shadow-2xl shadow-cyan-500/25 p-8 backdrop-blur-xl" }, _attrs))} data-v-faa36659><h3 class="text-2xl font-bold text-white mb-6 flex items-center gap-3" data-v-faa36659><div class="p-2 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg shadow-lg" data-v-faa36659><i class="bi bi-chat-square-text text-white" data-v-faa36659></i></div><span class="bg-gradient-to-r from-white via-cyan-100 to-blue-100 bg-clip-text text-transparent" data-v-faa36659>\u53D1\u8868\u8BC4\u8BBA</span></h3>`);
      if (!unref(userStore).isLoggedIn) {
        _push(`<div class="text-center py-8" data-v-faa36659><div class="text-4xl text-gray-400 mb-4" data-v-faa36659><i class="bi bi-person-plus" data-v-faa36659></i></div><h4 class="text-xl font-semibold text-white mb-2" data-v-faa36659>\u8BF7\u5148\u767B\u5F55</h4><p class="text-gray-400 mb-6" data-v-faa36659>\u767B\u5F55\u540E\u5373\u53EF\u53D1\u8868\u5BF9\u6B64\u4EA7\u54C1\u7684\u8BC4\u4EF7</p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<i class="bi bi-box-arrow-in-right mr-2" data-v-faa36659${_scopeId}></i> \u7ACB\u5373\u767B\u5F55 `);
            } else {
              return [
        ...
        _push(`<div class="text-center py-8" data-v-faa36659><div class="w-8 h-8 border-2 border-cyan-500 border-t-transparent rounded-full animate-spin mx-auto mb-4" data-v-faa36659></div><p class="text-gray-300" data-v-faa36659>\u6B63\u5728\u68C0\u67E5\u8BC4\u8BBA\u72B6\u6001...</p></div>`);
      } else if (hasReviewed.value && existingReview.value) {
        _push(`<div class="text-center py-8" data-v-faa36659><div class="text-4xl text-green-400 mb-4" data-v-faa36659><i class="bi bi-check-circle-fill" data-v-faa36659></i></div><h4 class="text-xl font-semibold text-white mb-2" data-v-faa36659>\u60A8\u5DF2\u8BC4\u8BBA\u8FC7\u6B64\u4EA7\u54C1</h4><p class="text-gray-400 mb-6" data-v-faa36659>\u6BCF\u4E2A\u4EA7\u54C1\u53EA\u80FD\u53D1\u5E03\u4E00\u6B21\u8BC4\u8BBA</p><div class="bg-gray-800/30 rounded-xl p-6 border border-gray-600/30 backdrop-blur-sm" data-v-faa36659><div class="flex items-center justify-center gap-2 mb-3" data-v-faa36659><div class="flex" data-v-faa36659><!--[-->`);
        ssrRenderList(5, (i) => {
          _push(`<i class="${ssrRenderClass([i <= existingReview.value.rating ? "text-yellow-400" : "text-gray-600", "bi bi-star-fill text-lg"])}" data-v-faa36659></i>`);
        });
        _push(`<!--]--></div><span class="text-white font-medium ml-2" data-v-faa36659>${ssrInterpolate(existingReview.value.rating)} \u5206</span></div><p class="text-gray-300 text-center" data-v-faa36659>${ssrInterpolate(existingReview.value.comment)}</p><p class="text-gray-500 text-sm text-center mt-3" data-v-faa36659> \u53D1\u5E03\u4E8E ${ssrInterpolate(new Date(existingReview.value.created_at).toLocaleDateString("zh-CN"))}</p></div></div>`);
      } else {
        _push(`<form class="space-y-6" data-v-faa36659><div data-v-faa36659><label class="block text-sm font-bold text-white mb-4 flex items-center gap-2" data-v-faa36659><i class="bi bi-star text-yellow-400" data-v-faa36659></i> \u8BC4\u5206 </label><div class="flex items-center gap-2" data-v-faa36659><!--[-->`);
        ssrRenderList(5, (i) => {
          ...
          ])}" data-v-faa36659><i class="bi bi-star-fill drop-shadow-lg" data-v-faa36659></i></button>`);
        });
        _push(`<!--]-->`);
        if (reviewData.value.rating > 0) {
          _push(`<span class="ml-4 text-white font-medium" data-v-faa36659>${ssrInterpolate(getRatingText(reviewData.value.rating))}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div data-v-faa36659><label class="block text-sm font-bold text-white mb-4 flex items-center gap-2" data-v-faa36659><i class="bi bi-chat-dots text-cyan-400" data-v-faa36659></i> \u8BC4\u8BBA\u5185\u5BB9 </label><textarea required rows="5" placeholder="\u8BF7\u5206\u4EAB\u60A8\u5BF9\u8FD9\u6B3E\u4EA7\u54C1\u7684\u4F7F\u7528\u4F53\u9A8C..." class="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 text-white placeholder-gray-400 resize-none" data-v-faa36659>${ssrInterpolate(reviewData.value.comment)}</textarea></div><div data-v-faa36659><label class="flex items-center space-x-3" data-v-faa36659><input${ssrIncludeBooleanAttr(Array.isArray(isAnonymous.value) ? ssrLooseContain(isAnonymous.value, null) : isAnonymous.value) ? " checked" : ""} type="checkbox" class="w-4 h-4 text-cyan-500 bg-transparent border-2 border-cyan-500 rounded focus:ring-cyan-500" data-v-faa36659><span class="text-gray-300" data-v-faa36659>\u533F\u540D\u53D1\u8868\uFF08\u4E0D\u663E\u793A\u7528\u6237\u540D\uFF09</span></label></div><div class="flex justify-end gap-4 pt-6" data-v-faa36659><button type="button" class="px-6 py-3 border border-gray-600/50 text-gray-300 hover:text-white hover:border-gray-500 rounded-lg font-medium transition-colors duration-300" data-v-faa36659> \u91CD\u7F6E </button><button type="submit"${ssrIncludeBooleanAttr(!canSubmit.value || isSubmitting.value) ? " disabled" : ""}${ssrRenderAttr("title", !canSubmit.value ? buttonDisabledReason.value : "")} class="review-submit-btn px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 disabled:from-gray-600 disabled:to-gray-600 text-white rounded-lg font-bold transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 disabled:cursor-not-allowed min-w-[160px]" data-v-faa36659><div class="flex items-center justify-center w-4 h-4" data-v-faa36659>`);
        if (isSubmitting.value || isCheckingReview.value) {
          _push(`<div class="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" data-v-faa36659></div>`);
        } else {
          _push(`<i class="bi bi-send" data-v-faa36659></i>`);
        }
        _push(`</div><span class="button-text" data-v-faa36659>${ssrInterpolate(buttonDisabledReason.value)}</span></button></div>`);
        if (!canSubmit.value && unref(userStore).isLoggedIn) {
          _push(`<div class="mt-4 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg" data-v-faa36659><div class="flex items-center gap-2 text-yellow-400 text-sm" data-v-faa36659><i class="bi bi-info-circle" data-v-faa36659></i><span data-v-faa36659>${ssrInterpolate(buttonDisabledReason.value)}</span></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</form>`);
...
const ReviewForm = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-faa36659"]]);
const pageSize = 5;
const _sfc_main = {
  __name: "[id]",
  __ssrInlineRender: true,
...
//# sourceMappingURL=_id_-Co9k5P0o.mjs.map
