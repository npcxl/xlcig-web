    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        ssrRenderList(unref(filteredOrders), (order) => {
          ...
          ])}" data-v-38fd0510><i class="${ssrRenderClass([getStatusIcon(order.status), "mr-2"])}" data-v-38fd0510></i> ${ssrInterpolate(getStatusLabel(order.status))}</div></div><div class="text-right" data-v-38fd0510><div class="text-2xl font-bold text-cyan-400" data-v-38fd0510>¥${ssrInterpolate((order.total * 7.2).toLocaleString())}</div><div class="text-gray-400 text-sm" data-v-38fd0510>${ssrInterpolate(order.items.length)} 件商品</div></div></div></div><div class="p-8" data-v-38fd0510><div class="space-y-4" data-v-38fd0510><!--[-->`);
...
//# sourceMappingURL=orders-DyUk0Ubk.js.map
