import { ref, createTextVNode, Fragment, Comment, inject, defineComponent, h, Teleport, computed, toRef, renderSlot, getCurrentInstance, isVNode, shallowRef, watchEffect, provide, Transition, TransitionGroup, mergeProps, nextTick, markRaw, cloneVNode, withDirectives, vShow, watch, normalizeClass, reactive, createApp, unref, readonly, toRefs } from "vue";
import { createId, getPadding, scaleColor, rgba, composite, depx, getPreciseEventTarget, changeColor, getMargin } from "seemly";
import { useFalseUntilTruthy, useIsMounted, useIsIos, useMemo, useClicked, useClickPosition } from "vooks";
...
const API_CONFIG = {
  BASE_URL: process.env.NODE_ENV === "production" ? "https://api.xlcig.cn/api" : "http://localhost:9999/api",
  TIMEOUT: 1e4
};
class ApiClient {
  constructor() {
...
export {
  ...
  self$1 as O,
  self as P,
  NConfigProvider as Q,
  XScrollbar as X,
  apiClient as a,
  createInjectionKey as b,
  createDiscreteApi as c,
  drawerBodyInjectionKey as d,
  getFirstVNode as e,
  LazyTeleport as f,
  getSlot as g,
  useSsrAdapter as h,
  commonVariables$3 as i,
  derived as j,
  c as k,
  cB as l,
  ...
  useThemeClass as w,
  isSlotEmpty as x,
  resolveWrappedSlot as y,
  getFirstSlotVNode as z
};
//# sourceMappingURL=useLocation-CdbkT8tR.js.map
