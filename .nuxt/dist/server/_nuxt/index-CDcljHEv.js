...
import "./useLocation-CdbkT8tR.js";
import "seemly";
import "vooks";
import "vdirs";
import "css-render";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_PageLoader, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black relative overflow-hidden" data-v-528b68ad${_scopeId}><div class="fixed inset-0 pointer-events-none" data-v-528b68ad${_scopeId}><div class="meteors-container" data-v-528b68ad${_scopeId}><div class="meteor meteor-1" data-v-528b68ad${_scopeId}></div><div class="meteor meteor-2" data-v-528b68ad${_scopeId}></div><div class="meteor meteor-3" data-v-528b68ad${_scopeId}></div><div class="meteor meteor-4" data-v-528b68ad${_scopeId}></div><div class="meteor meteor-5" data-v-528b68ad${_scopeId}></div><div class="meteor meteor-6" data-v-528b68ad${_scopeId}></div><div class="meteor meteor-7" data-v-528b68ad${_scopeId}></div><div class="meteor meteor-8" data-v-528b68ad${_scopeId}></div></div><div class="stars-container" data-v-528b68ad${_scopeId}><div class="stars stars-1" data-v-528b68ad${_scopeId}></div><div class="stars stars-2" data-v-528b68ad${_scopeId}></div><div class="stars stars-3" data-v-528b68ad${_scopeId}></div></div><div class="absolute top-20 left-20 w-96 h-96 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full filter blur-3xl animate-pulse" data-v-528b68ad${_scopeId}></div><div class="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full filter blur-3xl animate-pulse delay-1000" data-v-528b68ad${_scopeId}></div><div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-indigo-500/10 to-cyan-500/10 rounded-full filter blur-3xl animate-spin-slow" data-v-528b68ad${_scopeId}></div></div>`);
            ...
            _push2(`<section class="relative z-10 py-20" data-v-528b68ad${_scopeId}><div class="container mx-auto px-6" data-v-528b68ad${_scopeId}><div class="text-center" data-v-528b68ad${_scopeId}><div class="glass-card-dark rounded-3xl p-12 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-4xl mx-auto" data-v-528b68ad${_scopeId}><h1 class="text-5xl md:text-7xl font-bold text-white leading-tight mb-8" data-v-528b68ad${_scopeId}> 专业<span class="text-cyan-400" data-v-528b68ad${_scopeId}>xlCig</span><br data-v-528b68ad${_scopeId}><span class="text-3xl md:text-5xl text-gray-300 font-normal" data-v-528b68ad${_scopeId}>PC硬件专家</span></h1><p class="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed" data-v-528b68ad${_scopeId}> 为您提供专业的PC硬件产品和装机建议，助您打造梦想中的高性能电脑 </p><div class="flex flex-col sm:flex-row gap-4 justify-center items-center" data-v-528b68ad${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<i class="bi bi-lightning-fill mr-2 group-hover:animate-bounce" data-v-528b68ad${_scopeId2}></i> 立即开始 `);
                } else {
                  return [
            ...
            _push2(`<button class="inline-flex items-center px-8 py-3 border-2 border-cyan-500/50 hover:border-cyan-400 text-cyan-300 hover:text-white font-semibold rounded-xl transition-all duration-300 hover:bg-cyan-500/10 transform hover:-translate-y-1" data-v-528b68ad${_scopeId}><i class="bi bi-play-circle mr-2" data-v-528b68ad${_scopeId}></i> 观看演示 </button></div></div></div></div></section><section class="relative z-10 py-16" data-v-528b68ad${_scopeId}><div class="container mx-auto px-6" data-v-528b68ad${_scopeId}><div class="text-center mb-16" data-v-528b68ad${_scopeId}><h2 class="text-4xl font-bold text-white mb-4" data-v-528b68ad${_scopeId}>热门产品</h2><p class="text-gray-300 text-lg" data-v-528b68ad${_scopeId}>最受欢迎的PC硬件产品</p></div>`);
            if (featuredProducts.value.length === 0) {
              _push2(`<div class="text-center py-16" data-v-528b68ad${_scopeId}><div class="glass-card-dark rounded-2xl p-12 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-md mx-auto" data-v-528b68ad${_scopeId}><div class="text-8xl mb-8 text-cyan-400 opacity-50" data-v-528b68ad${_scopeId}><i class="bi bi-inbox" data-v-528b68ad${_scopeId}></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-528b68ad${_scopeId}>暂无热门产品</h3><p class="text-gray-400 mb-8 text-lg" data-v-528b68ad${_scopeId}>商家还没有上传产品，请稍后再来查看</p><button class="px-8 py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-medium rounded-lg transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40" data-v-528b68ad${_scopeId}><i class="bi bi-arrow-clockwise mr-2" data-v-528b68ad${_scopeId}></i> 重新加载 </button></div></div>`);
            } else {
              _push2(`<div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6" data-v-528b68ad${_scopeId}><!--[-->`);
              ssrRenderList(featuredProducts.value, (product) => {
                _push2(`<div class="glass-card-dark rounded-2xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 overflow-hidden hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2 group" data-v-528b68ad${_scopeId}><div class="relative h-48 bg-gradient-to-br from-gray-800/50 to-gray-900/50" data-v-528b68ad${_scopeId}>`);
                if (product.image) {
                  _push2(`<div class="home-product-image-container" data-v-528b68ad${_scopeId}><img${ssrRenderAttr("src", product.image)}${ssrRenderAttr("alt", product.name)} class="w-full h-full object-contain p-4 group-hover:scale-105 transition-transform duration-300" data-v-528b68ad${_scopeId}></div>`);
                } else {
                  _push2(`<div class="home-product-placeholder" data-v-528b68ad${_scopeId}><i class="${ssrRenderClass(getHomeProductIcon(product.name))}" data-v-528b68ad${_scopeId}></i><span class="home-product-type" data-v-528b68ad${_scopeId}>${ssrInterpolate(getProductTypeName(product.name))}</span></div>`);
                }
                _push2(`<div class="absolute top-3 right-3" data-v-528b68ad${_scopeId}><span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-500/20 text-green-300 border border-green-500/30" data-v-528b68ad${_scopeId}><i class="bi bi-fire mr-1" data-v-528b68ad${_scopeId}></i>热门 </span></div></div><div class="p-6" data-v-528b68ad${_scopeId}><h3 class="font-semibold text-white text-lg mb-2 line-clamp-2" data-v-528b68ad${_scopeId}>${ssrInterpolate(product.name)}</h3><p class="text-gray-400 text-sm mb-4 line-clamp-2" data-v-528b68ad${_scopeId}>${ssrInterpolate(product.description)}</p><div class="flex items-center justify-between" data-v-528b68ad${_scopeId}><div class="text-2xl font-bold text-cyan-400" data-v-528b68ad${_scopeId}>¥${ssrInterpolate(product.price.toLocaleString())}</div><div class="flex" data-v-528b68ad${_scopeId}><!--[-->`);
                ssrRenderList(5, (i) => {
                  _push2(`<i class="${ssrRenderClass([i <= product.rating ? "text-yellow-400" : "text-gray-600", "bi bi-star-fill text-sm"])}" data-v-528b68ad${_scopeId}></i>`);
                });
                _push2(`<!--]--></div></div><button class="w-full mt-4 px-4 py-2 bg-cyan-600 hover:bg-cyan-500 text-white text-sm font-medium rounded-lg transition-all duration-300" data-v-528b68ad${_scopeId}> 查看详情 </button></div></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            if (featuredProducts.value.length > 0) {
              _push2(`<div class="text-center mt-12" data-v-528b68ad${_scopeId}>`);
              _push2(ssrRenderComponent(_component_NuxtLink, {
                to: "/products",
                class: "inline-flex items-center px-8 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold rounded-xl transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 transform hover:-translate-y-1 group"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<i class="bi bi-collection mr-2 group-hover:animate-bounce" data-v-528b68ad${_scopeId2}></i> 浏览产品 `);
                  } else {
                    return [
            ...
            _push2(`</div></section><section class="relative z-10 py-16" data-v-528b68ad${_scopeId}><div class="container mx-auto px-6" data-v-528b68ad${_scopeId}><div class="text-center mb-16" data-v-528b68ad${_scopeId}><h2 class="text-4xl font-bold text-white mb-4" data-v-528b68ad${_scopeId}>装机配置推荐</h2><p class="text-gray-300 text-lg" data-v-528b68ad${_scopeId}>根据不同需求精心搭配的配置方案</p></div>`);
            if (configurations.value.length === 0) {
              _push2(`<div class="text-center py-16" data-v-528b68ad${_scopeId}><div class="glass-card-dark rounded-2xl p-12 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 max-w-md mx-auto" data-v-528b68ad${_scopeId}><div class="text-8xl mb-8 text-cyan-400 opacity-50" data-v-528b68ad${_scopeId}><i class="bi bi-cpu" data-v-528b68ad${_scopeId}></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-528b68ad${_scopeId}>暂无配置推荐</h3><p class="text-gray-400 mb-8 text-lg" data-v-528b68ad${_scopeId}>商家还没有上传配置方案，请稍后再来查看</p><button class="px-8 py-3 bg-cyan-600 hover:bg-cyan-700 text-white font-medium rounded-lg transition-all duration-300 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40" data-v-528b68ad${_scopeId}><i class="bi bi-arrow-clockwise mr-2" data-v-528b68ad${_scopeId}></i> 重新加载 </button></div></div>`);
            } else {
              _push2(`<div class="grid md:grid-cols-3 gap-8" data-v-528b68ad${_scopeId}><!--[-->`);
              ssrRenderList(configurations.value, (config) => {
                _push2(`<div class="glass-card-dark rounded-2xl border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 overflow-hidden hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2" data-v-528b68ad${_scopeId}><div class="p-6 border-b border-gray-700/50" data-v-528b68ad${_scopeId}><div class="flex items-center justify-between mb-4" data-v-528b68ad${_scopeId}><h3 class="text-2xl font-semibold text-white" data-v-528b68ad${_scopeId}>${ssrInterpolate(config.name)}</h3><span class="${ssrRenderClass(config.badgeClass)}" data-v-528b68ad${_scopeId}>${ssrInterpolate(config.badge)}</span></div><p class="text-gray-300 mb-4" data-v-528b68ad${_scopeId}>${ssrInterpolate(config.description)}</p><div class="text-3xl font-bold text-cyan-400 mb-2" data-v-528b68ad${_scopeId}>¥${ssrInterpolate(config.price.toLocaleString())}</div><div class="text-sm text-gray-400" data-v-528b68ad${_scopeId}>预估性能分数：${ssrInterpolate(config.score)}</div></div><div class="p-6" data-v-528b68ad${_scopeId}><div class="space-y-3 mb-6" data-v-528b68ad${_scopeId}><!--[-->`);
                ssrRenderList(config.components, (component) => {
                  _push2(`<div class="flex justify-between items-center p-3 bg-gray-800/30 rounded-lg" data-v-528b68ad${_scopeId}><span class="text-gray-300 text-sm" data-v-528b68ad${_scopeId}>${ssrInterpolate(component.type)}</span><span class="text-white text-sm font-medium" data-v-528b68ad${_scopeId}>${ssrInterpolate(component.name)}</span></div>`);
                });
                _push2(`<!--]--></div><button class="w-full px-4 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white font-semibold rounded-lg transition-all duration-300" data-v-528b68ad${_scopeId}> 选择此配置 </button></div></div>`);
              });
              _push2(`<!--]--></div>`);
            }
            _push2(`</div></section><section class="relative z-10 py-16" data-v-528b68ad${_scopeId}><div class="container mx-auto px-6" data-v-528b68ad${_scopeId}><div class="text-center mb-16" data-v-528b68ad${_scopeId}><h2 class="text-4xl font-bold text-white mb-4" data-v-528b68ad${_scopeId}>我们的服务</h2><p class="text-gray-300 text-lg" data-v-528b68ad${_scopeId}>专业的硬件选择和装机服务</p></div><div class="grid md:grid-cols-3 gap-8" data-v-528b68ad${_scopeId}><div class="glass-card-dark rounded-2xl p-8 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 text-center hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2" data-v-528b68ad${_scopeId}><div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-2xl flex items-center justify-center" data-v-528b68ad${_scopeId}><i class="bi bi-star-fill text-white text-2xl" data-v-528b68ad${_scopeId}></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-528b68ad${_scopeId}>精选产品</h3><p class="text-gray-300 leading-relaxed" data-v-528b68ad${_scopeId}>精心挑选的高品质PC硬件，确保性能与价格的完美平衡</p></div><div class="glass-card-dark rounded-2xl p-8 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 text-center hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2" data-v-528b68ad${_scopeId}><div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center" data-v-528b68ad${_scopeId}><i class="bi bi-currency-dollar text-white text-2xl" data-v-528b68ad${_scopeId}></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-528b68ad${_scopeId}>优惠价格</h3><p class="text-gray-300 leading-relaxed" data-v-528b68ad${_scopeId}>直接与厂商合作，为您提供最具竞争力的价格和促销活动</p></div><div class="glass-card-dark rounded-2xl p-8 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20 text-center hover:border-cyan-400/50 transition-all duration-300 transform hover:-translate-y-2" data-v-528b68ad${_scopeId}><div class="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center" data-v-528b68ad${_scopeId}><i class="bi bi-joystick text-white text-2xl" data-v-528b68ad${_scopeId}></i></div><h3 class="text-2xl font-semibold text-white mb-4" data-v-528b68ad${_scopeId}>游戏体验</h3><p class="text-gray-300 leading-relaxed" data-v-528b68ad${_scopeId}>针对游戏需求优化的配置方案，让您享受极致的游戏体验</p></div></div></div></section><footer class="relative z-10 mt-20" data-v-528b68ad${_scopeId}><div class="container mx-auto px-6 py-12" data-v-528b68ad${_scopeId}><div class="glass-card-dark rounded-2xl p-8 border border-cyan-500/30 shadow-2xl shadow-cyan-500/20" data-v-528b68ad${_scopeId}><div class="text-center" data-v-528b68ad${_scopeId}><div class="flex justify-center mb-4" data-v-528b68ad${_scopeId}>`);
            _push2(ssrRenderComponent(_component_AppLogo, {
              size: "medium",
              "show-decorations": false
            }, null, _parent2, _scopeId));
            _push2(`</div><p class="text-gray-300 mb-6" data-v-528b68ad${_scopeId}>专业的PC硬件产品和装机服务</p><div class="flex justify-center space-x-6 text-gray-400" data-v-528b68ad${_scopeId}><a href="#" class="hover:text-cyan-400 transition-colors duration-200" data-v-528b68ad${_scopeId}>关于我们</a><a href="#" class="hover:text-cyan-400 transition-colors duration-200" data-v-528b68ad${_scopeId}>联系方式</a><a href="#" class="hover:text-cyan-400 transition-colors duration-200" data-v-528b68ad${_scopeId}>服务条款</a><a href="#" class="hover:text-cyan-400 transition-colors duration-200" data-v-528b68ad${_scopeId}>隐私政策</a></div><div class="mt-6 pt-6 border-t border-gray-700/50 text-gray-500 text-sm" data-v-528b68ad${_scopeId}> © 2024 xlCig. 保留所有权利. </div></div></div></div></footer></div>`);
          } else {
            return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-528b68ad"]]);
export {
  index as default
};
//# sourceMappingURL=index-CDcljHEv.js.map
