...
import { createHooks } from "D:/code/xlweb/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/code/xlweb/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/code/xlweb/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia, defineStore } from "pinia";
import { defu } from "D:/code/xlweb/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "D:/code/xlweb/node_modules/radix3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "D:/code/xlweb/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CDcljHEv.js")
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import("./_nuxt/orders-CwrdKYbl.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-CBsxMrVg.js")
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import("./_nuxt/checkout-lE9SkT1q.js")
  },
  {
    name: "addresses",
    path: "/addresses",
    component: () => import("./_nuxt/addresses-B1IZy_br.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import("./_nuxt/login-DrUfdtJb.js")
  },
  {
    name: "my-reviews",
    path: "/my-reviews",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/my-reviews-Cq8qQOb0.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import("./_nuxt/register-Dh7eeVy0.js")
  },
  {
    name: "location-test",
    path: "/location-test",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/location-test-6QheEf0S.js")
  },
  {
    name: "products-id",
    path: "/products/:id()",
    component: () => import("./_nuxt/_id_-Co9k5P0o.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/index-Do6ICNu9.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-CYA3K5EL.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Bocym40J.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-VLhr_h-L.js"));
