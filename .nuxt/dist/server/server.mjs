import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, mergeProps, useSSRContext, ref, Suspense, Fragment, computed, unref, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/codeGitee/xlweb/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/codeGitee/xlweb/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/codeGitee/xlweb/node_modules/h3/dist/index.mjs";
import { shouldHydrate, createPinia, setActivePinia, defineStore } from "pinia";
import { defu } from "D:/codeGitee/xlweb/node_modules/defu/dist/defu.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "D:/codeGitee/xlweb/node_modules/radix3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "D:/codeGitee/xlweb/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-KLHvv1kS.js")
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import("./_nuxt/orders-BsJng6wf.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-Cbvb-ZsI.js")
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import("./_nuxt/checkout-B7M91ud5.js")
  },
  {
    name: "addresses",
    path: "/addresses",
    component: () => import("./_nuxt/addresses-BPCHn4Oj.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import("./_nuxt/login-C8P9xApR.js")
  },
  {
    name: "my-reviews",
    path: "/my-reviews",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/my-reviews-DCzte3st.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import("./_nuxt/register-CeiEZD5c.js")
  },
  {
    name: "location-test",
    path: "/location-test",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/location-test-B9WarcDJ.js")
  },
  {
    name: "products-id",
    path: "/products/:id()",
    component: () => import("./_nuxt/_id_-BQlCXwL6.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/index-Da5wag4a.js")
  },
  {
    name: "customer-service",
    path: "/customer-service",
    component: () => import("./_nuxt/customer-service-CRyBHgtO.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-K3IFp1Cx.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-B3uY9rp7.js"));
