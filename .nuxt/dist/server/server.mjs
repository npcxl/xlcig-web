...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-D4hF5GpD.js")
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import("./_nuxt/orders-B0OUWkt8.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-BF2HD-eV.js")
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import("./_nuxt/checkout-BDiofAj7.js")
  },
  {
    name: "addresses",
    path: "/addresses",
    component: () => import("./_nuxt/addresses-D-WBD8ZJ.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import("./_nuxt/login-Bp78Oxot.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import("./_nuxt/register-Bgylc00U.js")
  },
  {
    name: "location-test",
    path: "/location-test",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/location-test-HVvjxCSH.js")
  },
  {
    name: "products-id",
    path: "/products/:id()",
    component: () => import("./_nuxt/_id_-2j4w7VkR.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/index-Bx9YYt0O.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-DeWW0Tvs.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-0aEqn7oY.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Bm2rU_Uk.js"));
